...
static NSString * const kConsumerKey       = @"QKPFdTkFGEFShCnqPY357g";
static NSString * const kConsumerSecret    = @"6LDW-ztFwfpCQ1V0Z4l872P3jpQ";
static NSString * const kToken             = @"QPXXc3ZubVvX0eBKFigyYcQJZBELuQQy";
static NSString * const kTokenSecret       = @"_Z19m57n7IznkNWFYhvrhst5FM4";
